    ...
    <>
      {!ipfsReady && (
        ...
        >
          ...
          <code className="font-mono bg-yellow-100 px-1 rounded">PINATA_API_KEY</code> and{' '}
          <code className="font-mono bg-yellow-100 px-1 rounded">PINATA_API_SECRET</code> on the
          server to enable metadata uploads.
        </div>
      )}
