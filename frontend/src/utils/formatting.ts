 ...
 *
 * Returns null - rather than passing the value through - for anything that
 * isn't a well-formed ipfs:// URI. Metadata is pinned by whoever calls
 * set_metadata, so it's attacker-controlled; passing it through would let a
 * malicious http:// or data: URL flow straight into an <img src> as a tracking
 * pixel or SSRF vector.
 */
