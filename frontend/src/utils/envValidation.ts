...
const ENV_VARS: EnvVar[] = [
  ...
  // Pinata credentials are deliberately absent: they live server-side, read by
  // the api/ipfs/* proxy. Referencing them as VITE_ vars here would inline them
  // into the client bundle - the exact leak this validation list must not cause.
  {
    key: 'VITE_SENTRY_DSN',
