...
// The deploy unit is the repo root, not frontend/ - Vercel needs to build the
// api/ipfs/* serverless functions alongside the SPA, so the root vercel.json is
// the one it actually reads.
